...
const styles = StyleSheet.create({
  ...
  title: { ...type.titleKo, fontSize: 19, color: colors.text, marginTop: 2 },
  desc: { ...type.bodyKo, color: colors.textSecondary, fontSize: 15, lineHeight: 25, marginTop: spacing.sm },
});
